...
from making_model import load_data, make_X_Y, compute_metrics, univariate_ftest_feature_subset
from making_model import split_data, decision_tree, RF, evaluate_model, reverse_selection_feature_subset
from making_model import hyperparam_optimize_n_trees, RF_Classifier
from sklearn.ensemble import RandomForestClassifier

DATAPATH = 'data/cleaned_data.pkl'
MODELPATH = 'Trained_Production_RF_Classifier_230314.pkl'
COLUMNPATH = 'Trained_Production_RF_Classifier_features_230314.pkl'
...
class Test_RF_Classifier_Class(unittest.TestCase):
    ...
    def test_init(self):
        ...
        model = RF_Classifier(MODELPATH, COLUMNPATH)
        assert True
